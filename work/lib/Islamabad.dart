                ...
                itemBuilder: (context, index) {
                  List<Map<String, String>> karachiAttractions = [
                    ...
                    },
                    {
                      ...
                      'title': 'Mall',
                      'description':
                          'A famous area with shopping centers and restaurants.',
                    },
                    {
                      'image': 'assets/images/karachitower.jpg',
                      'title': 'Karachi Tower',
                      'description':
                          'An iconic tower offering panoramic city views.',
                    },
                    {
                      'image': 'assets/images/karachiZoo.jfif',
                      'title': 'Karachi Zoo',
                      'description':
                          'A large zoo featuring a variety of animals.',
                    },
                    {
                      'image': 'assets/images/paf museum Karachi.jpg',
                      'title': 'Karachi Museum',
                      'description':
                          'A museum displaying the rich history of the city.',
                    },
                    {

      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Explore Abbottabad Attractions',
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  List<Map<String, String>> AbbottabadAttractions = [
                    {
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Image.asset(
                            AbbottabadAttractions[index]['image']!,
                            height: 140,
                          ...
                          Text(
                            AbbottabadAttractions[index]['title']!,
                          ...
                          Text(
                            AbbottabadAttractions[index]['description']!,
                            style: const TextStyle(
                              fontSize: 12,
                              color: Colors.grey,
                            ),

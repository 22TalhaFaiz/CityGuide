...
class Multan extends StatelessWidget {
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  List<Map<String, String>> multanAttractions = [
                    {
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            multanAttractions[index]['description']!,
                            style: const TextStyle(
                              fontSize: 12,
                              color: Colors.grey,
                            ),

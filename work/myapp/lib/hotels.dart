...
class _hotelsState extends State<hotels> {
  ...
  void fetchData() async {
    final userdata = await FirebaseFirestore.instance.collection('Hotels').get();
  ...
  void updateData(String docId, Map<String, dynamic> newData) async {
    try {
      final db = FirebaseFirestore.instance.collection('Hotels');
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                FirebaseFirestore.instance.collection('Hotels').add(newProduct);
                Navigator.of(context).pop();

...
class _IslamabadState extends State<Islamabad> {
  ...
  void updateData(String docId, Map<String, dynamic> newData) async {
    try {
      final db = FirebaseFirestore.instance.collection('Islamabad');
      await db.doc(docId).update(newData); // Use document ID to update
      print("Islamabad updated successfully!");
  ...
  void deleteData(String docId) async {
    try {
      ...
      print("Islamabad deleted successfully!");

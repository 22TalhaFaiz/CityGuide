...
class _LahoreState extends State<Lahore> {
  ...
  void updateData(String docId, Map<String, dynamic> newData) async {
    try {
      final db = FirebaseFirestore.instance.collection('Lahore');
      await db.doc(docId).update(newData); // Use document ID to update
      print("Lahore updated successfully!");
    } catch (e) {
  ...
  void deleteData(String docId) async {
    try {
      ...
      print("Lahore deleted successfully!");
    } catch (e) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                FirebaseFirestore.instance.collection('Lahore').add(newProduct);
                Navigator.of(context).pop();

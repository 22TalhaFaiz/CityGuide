          ...
          children: [
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Colors.white,
                      shadows: [
                        Shadow(color: Colors.black.withOpacity(0.7), offset: Offset(3, 3), blurRadius: 5),
                      ],
                    ),
                  ),
                  SizedBox(height: 10),
                  // Add an Image below the welcome text (Replace URL with your image)
                  Image.network('https://www.istockphoto.com/vector/bookshelves-gm854608904-140850519', height: 100, width: 100),
                ],
              ),
            ),
            SizedBox(height: 20),
            ...
            Expanded(
              child: GridView.count(
                ...
                crossAxisSpacing: 12,
                mainAxisSpacing: 24,
                childAspectRatio: 0.99,  // Adjust the size of the cards (make them smaller)
                children: [
                  // Total Users Card
                  Card(
                    elevation: 5,
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [Colors.black, Colors.grey],  // Gradient colors for the Users card
                      ...
                      child: Center(
                        child: ListTile(
                          ...
                          title: Text('Users', style: TextStyle(color: Colors.white, fontSize: 20)),
                          subtitle: Text(userCount.toString(), style: TextStyle(color: Colors.white, fontSize: 36)),
                        ),
                      ),
                    ),
                  ),
                  ...
                  Card(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [const Color.fromARGB(255, 255, 255, 255), Colors.grey],  // Gradient colors for the Books card
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                        borderRadius: BorderRadius.circular(15),
                      ...
                      child: Center(
                        child: ListTile(
                          leading: Icon(Icons.book, color: Colors.white, size: 40),
                          title: Text('Books', style: TextStyle(color: Colors.white, fontSize: 20)),
                          subtitle: Text(bookCount.toString(), style: TextStyle(color: Colors.white, fontSize: 36)),
                        ),
                      ),
                    ),
                  ),
                  ...
                  Card(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors:  [Colors.black, Colors.grey], // Gradient colors for the Categories card
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                        borderRadius: BorderRadius.circular(15),
                      ...
                      child: Center(
                        child: ListTile(
                          leading: Icon(Icons.category, color: Colors.white, size: 40),
                          title: Text('Categories', style: TextStyle(color: Colors.white, fontSize: 20)),
                          subtitle: Text(categoryCount.toString(), style: TextStyle(color: Colors.white, fontSize: 36)),
                        ),
                      ),
                    ),
                  ),
                    ...
                    return Card(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            leading: Icon(Icons.category, color: Colors.white, size: 40),
                            title: Text('Category: ${entry.key}', style: TextStyle(color: Colors.white, fontSize: 20)),
                            subtitle: Text('Books: ${entry.value}', style: TextStyle(color: Colors.white, fontSize: 36)),
                          ),
                        ),
                      ),
                    );
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: Text('Niha Siddiqui', style: TextStyle(color: Colors.white)),
              accountEmail: Text('nihasiddiqui@gmail.com', style: TextStyle(color: Colors.white)),
